...
// function change(){
        ...
        $message021120A = fetch_value($021120A,'"message":"','"');
        if(strpos($021120A, 'Promo kamu sudah bisa dipakai.')){
        echo "\n".color("green","+] Message: ".$message021120A);
        goto goride;
        }else{
        echo "\n".color("red","-] Message: ".$message021120A);
        echo "\n".color("yellow","!] Claim voc GOFOOD021120A");
        echo "\n".color("yellow","!] Please wait");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
